...
class SpecialOccassionAlertWithFrequency extends Component {
    render() {
        return (
            <div className="card card-default mt-10">
                <div className="card-header">
                    <h4 className="card-title">Special Occassion Specific Alert (With Freq)</h4>
                </div>
                {/* /.card-header */}
...
export default SpecialOccassionAlertWithFrequency;