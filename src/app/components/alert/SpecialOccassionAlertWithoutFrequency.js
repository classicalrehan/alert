...
class SpecialOccassionAlertWithoutFrequency extends Component {
    render() {
        return (
            <div className="card card-default mt-10">
                <div className="card-header">
                    <h4 className="card-title">Special Occassion Specific Alert (Without Freq)</h4>
                </div>
                {/* /.card-header */}
...
export default SpecialOccassionAlertWithoutFrequency;